...
### AI Domain ###
python main.py --exp_name ai_directly_finetune --exp_id 1 --num_tag 29 --batch_size 16 --ckpt ai_keywords_model/pytorch_model.bin --tgt_dm ai --conll --joint --lr 1e-5
## Directly Fine-tune
...
python main.py --exp_name music_directly_finetune --exp_id 1 --num_tag 27 --batch_size 16 --ckpt music_keywords_model/pytorch_model.bin --tgt_dm music --lr 6e-5

python main.py --exp_name music_conll_finetune --exp_id 1 --num_tag 27 --batch_size 16 --ckpt music_keywords_model/pytorch_model.bin --tgt_dm music --conll

python main.py --exp_name music_conll_joint_finetune --exp_id 1 --num_tag 27 --batch_size 16 --ckpt music_keywords_model/pytorch_model.bin --tgt_dm music --conll --joint --lr 1e-5
